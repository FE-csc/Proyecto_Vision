...
/**
 * VIEWPORT
 * Configuración para responsive design en dispositivos móviles
 */
...
/**
 * TAILWIND CSS CDN
 * Framework CSS utility-first con plugins:
 *   - forms: Estilos mejorados para formularios
...
/**
 * GOOGLE FONTS: INTER
 * Tipografía principal del diseño
 ...
 * Usados para: flechas, calendario, personas, etc.
 */
<link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&amp;display=swap" rel="stylesheet"/>

/**
 * ESTILOS PERSONALIZADOS
 * Configuración de variaciones de fuente para Material Symbols
 */
<style>
    .material-symbols-outlined {
 ...
 * 
 * darkMode: "class"
 *   - Modo oscuro basado en clase .dark en elemento padre
 * 
...
async function guardarNota(e) {
   ...
   */
  if (!select.value) { alert('Seleccione paciente'); return; }
  if (!fecha) { alert('Seleccione fecha'); return; }
  if (!contenido) { alert('Escriba el contenido'); return; }
