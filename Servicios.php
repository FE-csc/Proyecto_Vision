...
<!--
  Servicios.php - Página estática que lista los servicios ofrecidos.
  - Contiene contenido informativo y enlaces (por ejemplo a View_Reserva.php) que
    pueden ser protegidos por auth.js en caso de requerir sesión.
  - auth.js está incluido en la parte inferior para gestionar estado de sesión y avatar.
-->
