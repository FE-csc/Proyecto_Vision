        ...
        <main class="flex-1 p-8 grid grid-cols-12 gap-8">
            <div class="col-span-12 lg:col-span-8 flex flex-col gap-6">
                ...
                <div class="flex flex-wrap justify-between items-center gap-3">
                    <div class="flex flex-col gap-2">
                        <h1
                            class="text-slate-900 dark:text-slate-100 text-4xl font-black leading-tight tracking-[-0.033em]">
                            Notas y Evolución del Paciente</h1>
                        <p class="text-slate-500 dark:text-slate-400 text-base font-normal leading-normal">Gestiona y
                            rastrea las notas clínicas y el progreso terapéutico del paciente.</p>
                    </div>
                    <a href="CrearNotas.php"
                ...
                <!-- Tabla de notas -->
                <div
                    class="w-full bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm">
                            <thead
                                class="bg-slate-50 dark:bg-slate-800/50 text-slate-600 dark:text-slate-300 uppercase text-xs">
                                <tr>
            ...
            <div class="col-span-12 lg:col-span-4 flex flex-col gap-6">
                ...
                <label class="flex flex-col w-full">
                    <p class="text-slate-900 dark:text-slate-100 text-base font-medium leading-normal pb-2">Buscar
                        Paciente</p>
                    <div class="flex w-full items-stretch rounded-lg">
                        <input
                            class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 focus:border-primary dark:focus:border-primary h-14 placeholder:text-slate-400 dark:placeholder:text-slate-500 p-4 rounded-r-none border-r-0 text-base font-normal leading-normal"
                            placeholder="Buscar o seleccionar paciente..." value="" />
                        <div
                            class="text-slate-400 dark:text-slate-500 flex border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 items-center justify-center pr-4 rounded-r-lg border-l-0">
                            <span class="material-symbols-outlined">search</span>
                        </div>
                    </div>
                    <!-- Suggestions container -->
                    <div id="patient-suggestions"
                        class="mt-2 bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden hidden">
                    </div>
                </label>
                <!-- Card -->
                <div
                    class="flex flex-col gap-4 rounded-xl bg-white dark:bg-slate-900 p-4 shadow-sm border border-slate-200 dark:border-slate-800">
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex flex-col gap-1">
                            <p class="text-slate-500 dark:text-slate-400 text-sm font-normal leading-normal">Paciente
                                Seleccionado</p>
                            <p class="text-slate-900 dark:text-slate-100 text-base font-bold leading-tight">-</p>
                            <p class="text-slate-500 dark:text-slate-400 text-sm font-normal leading-normal">Última
                                sesión: -</p>
                        </div>
                    </div>
                </div>
    ...
    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
      ...
      <td class="px-6 py-4 text-right">
        <div class="flex justify-end gap-2">
          <a href="EditarNotas.php?id=${n.ID_Nota}" class="inline-flex items-center justify-center h-8 w-8 rounded-lg text-primary hover:bg-primary/10"><span class="material-symbols-outlined text-base">edit</span></a>
