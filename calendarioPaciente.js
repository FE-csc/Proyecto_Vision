/**
 * ════════════════════════════════════════════════════════════════════════════════
 * SCRIPT: calendarioPaciente.js
 * ════════════════════════════════════════════════════════════════════════════════
 * 
 * Descripción:
 *   - Inicializa y configura FullCalendar en el contenedor #calendar
 *   - Carga eventos (citas) desde calendarioPaciente.php mediante AJAX
 ...
 *   - Carga dinámica de eventos desde calendarioPaciente.php
 *   - Codificación de colores por estado de cita
 * 
 * Dependencias:
 *   - FullCalendar 6.1.8
 *   - jQuery 3.5.1 (para AJAX)
 *   - calendarioPaciente_View.php (vista HTML)
 *   - calendarioPaciente.php (backend API)
 * 
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /**
   * Obtener el ID del paciente desde atributo data-paciente
   * Este ID se usa para cargar las citas específicas de este paciente
   * Se pasa desde calendarioPaciente_View.php
   */
  ...
  const calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    events: function(fetchInfo, successCallback, failureCallback) {
      /**
       * Realizar solicitud AJAX GET a calendarioPaciente.php
       * 
       * Parámetros:
       *   - idPaciente: ID del paciente para obtener sus citas
       * 
       * Respuesta esperada:
    ...
    eventClick: function(info) {
       ...
       * Contiene información adicional como fecha, hora, psicólogo, etc.
       */
       ...
       *   - 👨‍⚕️ Psicólogo: Nombre del profesional
